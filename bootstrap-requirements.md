...
- The bootstrap.sh will contain the necessary commands to setup a few basic tools to get started.
...
- It will echo the public keys to the terminal, id_rsa will be copied to the clipboard using pbcopy.
