    ...
    dashboard = {
      ...
      preset = {
        ...
        keys = {
          ...
          { icon = "",  key = "$", desc = "Dashboard", action = ":e ~/.dotfiles/nvim/lua/plugins/navigation/snacks-dashboard.lua" },
        },
      },
      sections = {
        { section = "header" },
        {
          icon = "󰌪 ", title = "Vimprove", section = "terminal",
          cmd = (function()
            local tips = {
          ...
          height = 1, padding = 1, indent = 0, align = "center",
        },
